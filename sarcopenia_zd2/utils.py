...
##  same weights of networks
def save_checkpoint(state, filename="/content/drive/MyDrive/sarcopenia_zd2/my_checkpoint.pth.tar"):
    #  print("=> Saving checkpoint")
    torch.save(state, filename)

## load weights of networks
def load_checkpoint(checkpoint, model):
    #  print("=> Loading checkpoint")
    model.load_state_dict(checkpoint["state_dict"])

##  load niftis and hyperparameters
def get_loaders(
    train_dir,
    train_maskdir,
    val_dir,
